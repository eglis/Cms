...
class IndexController extends AbstractActionController
{
    ...
    public function pageAction ()
    {
        ...
        $page = $this->pageService->findByUri($slug, $this->locale);
    	...
    	if($page){
    		...
    		$this->flashMessenger()->setNamespace('danger')->addMessage(sprintf($this->translator->translate('The page with the url "%s" has been not found!'), $slug));
